class dofus.§\x1d\x19\x0e§.gapi.§\x1e\x1b\x19§.MountWeight extends dofus.§\x1d\x19\x0e§.gapi.§\x1e\x1b\x10§.§\x1e\x13\x15§
{
   static var §\x01\x0f§ = "MountWeight";
   ...
   {
      super["\x1d\x13\x1a"](false,dofus["\x1d\x19\x0e"].gapi["\x1e\x1b\x19"].MountWeight["\x01\x0f"]);
   }
   ...
   function §\x1d\x05§()
   {
      ...
      this.api["\x1e\x18\x05"]["\x1b\x17\r"].mount["\x1d\x15"]("podsChanged",this);
   }
   function §\x1d\x13\n§()
   {
   ...
   function podsChanged(§\x1c\n\x07§)
   {
      var _loc3_ = this.api["\x1e\x18\x05"]["\x1b\x17\r"].mount.podsMax;
      var _loc4_ = this.api["\x1e\x18\x05"]["\x1b\x17\r"].mount.pods;
