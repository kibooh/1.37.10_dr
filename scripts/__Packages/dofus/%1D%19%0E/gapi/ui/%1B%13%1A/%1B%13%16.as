class dofus.§\x1d\x19\x0e§.gapi.ui.§\x1b\x13\x1a§.§\x1b\x13\x16§ extends §\x19\x04§.gapi.§\x1e\x1b\x10§.§\x1a\t\x16§
{
   function §\x1b\x13\x16§()
   {
      super();
   }
   ...
   function §\x1b\x01\x1b§(§\b\x16§, §\x1a\x13\x1d§, §\x1c\t\x17§)
   {
      if(_loc2_)
      {
         ...
         this["\x19\x01\x0b"].text = _loc4_.label;
